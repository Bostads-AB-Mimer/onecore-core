...
const getLeasesForPnr = async (
  ...
  const leasesResponse = await axios.get(
    `${tenantsLeasesServiceUrl}/v2/leases/for/nationalRegistrationNumber/${nationalRegistrationNumber}?${queryParams.toString()}`
  )
...
const getLeasesForContactCode = async (
  ...
  const leasesResponse = await axios.get(
    `${tenantsLeasesServiceUrl}/v2/leases/for/contactCode/${contactCode}?${queryParams.toString()}`
  )
...
const getLeasesForPropertyId = async (
  ...
  const leasesResponse = await axios(
    `${tenantsLeasesServiceUrl}/v2/leases/for/propertyId/${propertyId}?${queryParams.toString()}`
  )
...
const createLease = async (
  ...
  const result = await axios(
    tenantsLeasesServiceUrl + '/v2/leases',
    axiosOptions
  )
